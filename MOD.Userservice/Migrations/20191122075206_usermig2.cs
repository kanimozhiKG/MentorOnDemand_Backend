    ...
    public partial class usermig2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Active", "EmailID", "Mobilenumber", "Name", "Password" },
                values: new object[] { 1L, true, "iiiiiiiii", 4000034655L, "aaaaaa", "ifgdfd" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "Active", "EmailID", "Mobilenumber", "Name", "Password" },
                values: new object[] { 2L, true, "iiiiiiiii", 7889334655L, "afdhgvha", "lkjhgfdsa" });
